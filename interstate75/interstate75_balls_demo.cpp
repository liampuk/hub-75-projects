...
Hub75 hub75(160, 32, nullptr, PANEL_FM6126A, false);
//or using 2 of these panels
...
int main() {
  ...
  Pen ORANGE = graphics.create_pen(255, 126, 0);
  ...
  while(true) {
    ...
    graphics.text("1 Elephant & Castle", Point(0,0), 160, 1.0f);
    graphics.text("12 min", Point(132,0), 160, 1.0f);

    
    graphics.text("2 London Euston", Point(0,8), 160, 1.0f);
    graphics.text("14 min", Point(132,8), 160, 1.0f);

    
    graphics.text("1 Elephant & Castle", Point(0,16), 160, 1.0f);
    graphics.text("12 min", Point(132,16), 160, 1.0f);

    graphics.text("00:14", Point(70,25), 160, 1.0f);
